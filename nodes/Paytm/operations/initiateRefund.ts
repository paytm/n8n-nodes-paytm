...
import { assertMandatoryNumber, assertMandatoryStrings } from '../utils/mandatoryFieldError';
...
function buildRefundItemsPayload(raw: unknown, node: INode, itemIndex: number): unknown | undefined {
...
export const initiateRefundDescription: INodeProperties[] = [
	{
		...
		default: '',
		required: true,
		description: 'Merchant generated order ID for refund',
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'Transaction ID generated by Paytm to initiate refund',
		displayOptions: INITIATE_REFUND_SHOW,
	},
	{
		...
		description: 'Request type (Paytm supports REFUND for this API)',
		displayOptions: INITIATE_REFUND_SHOW,
	},
	{
...
export async function executeInitiateRefund(
	...
	const res = (await client.requestWithChecksum('POST', '/refund/apply', body)) as PaytmChecksumApiResponse;
